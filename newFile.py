...
def conv_op(input_op,name,kh,kw,n_out,dh,dw,p):
    ...
    with tf.name_scope(name) as scope:
        ...
        print(conv.name,"|", conv.shape ,"|", input_op.shape ,"|", kernel.shape ,"|", (1,dh,dw,1)[1:-1],file = f)
...
def fc_op(input_op,name,n_out,p):
    ...
    with tf.name_scope(name) as scope:
        ...
        print(activation.name,"|", activation.shape ,"|", input_op.shape ,"|", kernel.shape ,file = f)
        p += [kernel,biases]
        return activation
...
def mpool_op(input_op,name,kh,kw,dh,dw):
    ...
    print(m.name,"|", m.shape ,"|", input_op.shape ,"|", [1,kh,kw,1][1:-1] ,"|", [1,dh,dw,1][1:-1],file = f)
    return m
